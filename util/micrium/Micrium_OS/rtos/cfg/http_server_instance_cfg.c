...
*
* File : http_server_instance_cfg.c
*********************************************************************************************************
*/
...
#include  "http_server_instance_cfg.h"
...
#define  HTTPs_INSTANCE_TASK_PRIO                        12
#define  HTTPs_OS_CFG_INSTANCE_TASK_PRIO                 12

#define  HTTPs_INSTANCE_TASK_STK_SIZE                  2048
#define  HTTPs_OS_CFG_INSTANCE_TASK_STK_SIZE           2048
...
const  RTOS_TASK_CFG  HTTPs_TaskCfgInstance = {
...
*/
    ...
    /* CPU_INT08U  FS_PathLenMax                                                                                        */
                                                                /* Maximum Length of the File System path.              */
    256,
