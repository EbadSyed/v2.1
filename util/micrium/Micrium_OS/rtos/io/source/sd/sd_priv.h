...
typedef  struct  sd {
    ...
    KAL_SEM_HANDLE         EventSemHandle;                      /**< Handle to semaphore to trigger bus event.          */

    MEM_DYN_POOL           EventPool;                           /**< Pool of SD event structures.                       */
    SD_EVENT              *EventHeadPtr;                        /**< Head of SD event list.                             */
    SD_EVENT              *EventTailPtr;                        /**< Tail of SD event list.                             */
