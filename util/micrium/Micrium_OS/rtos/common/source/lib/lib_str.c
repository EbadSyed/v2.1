...
*
* Argument(s) : p_str       Pointer to the string. This string is not modified.
*
* Return(s)   : Length of a string; number of characters in a string before the terminating NULL
*               character.
*
* Note(s)     : (1) See notes for Str_Len_N().
*********************************************************************************************************
*/
...
* Argument(s) : p_str       Pointer to the string. This string is not modified.
*
*               len_max     Maximum number of characters to search. Does NOT include the terminating NULL
*                           character.
*
* Return(s)   : Length of string; number of characters in string before terminating NULL character, if
*               terminating NULL character found.
*
*               Requested maximum number of characters to search, if terminating NULL character NOT
*               found.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strlen() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strlen() : RETURN VALUE' states that :
*
...
*
* Argument(s) : p_str_dest  Pointer to the destination string buffer to receive source string copy.
...
*
*               p_str_src   Pointer to the source string to copy into destination string buffer. This
*                           string is not modified.
*
* Return(s)   : Pointer to the destination string, if NO error(s).
*
*               Pointer to NULL, otherwise (see Note #2).
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strcpy() : DESCRIPTION' states that :
*
...
*                   null byte)."
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strcpy() : RETURN VALUE' states that :
*
...
*                   error(s).
*
*               (3) IEEE Std 1003.1, 2004 Edition, Section 'strcpy() : DESCRIPTION' states that:
*
*                   "if copying takes place between objects that overlap, the behavior is undefined".
*
*               (4) String copy terminates when :
*
...
*                           string is not modified.
*
*               len_max     Maximum number of characters to copy. 'len_max' number of characters MAY
*                           include the terminating NULL character. Zero-length copies allowed.
*
* Return(s)   : Pointer to destination string, if NO error(s).
*
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strncpy() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strncpy() : DESCRIPTION' states that :
*
...
*
*               (3) IEEE Std 1003.1, 2004 Edition, Section 'strncpy() : APPLICATION USAGE' states that :
*
...
*
*               (4) IEEE Std 1003.1, 2004 Edition, Section 'strncpy() : RETURN VALUE' states that :
*
...
*
*               (5) IEEE Std 1003.1, 2004 Edition, Section 'strncpy() : DESCRIPTION' states that :
*
*                   "if copying takes place between objects that overlap, the behavior is undefined".
*
*               (6) String copy terminates when :
*
*                   (a) Destination/Source string pointer(s) are passed as NULL pointers. No string copy
*                       performed; NULL pointer is returned.
*
...
*
* Argument(s) : p_str_dest  Pointer to the destination string to append concatenation string. Destination
...
*
*               p_str_cat   Pointer to the concatenation string to append to destination string.
...
*               Pointer to NULL, otherwise (see Note #2).
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strcat() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strcat() : RETURN VALUE' states that :
*
...
*                   error(s).
*
*               (3) IEEE Std 1003.1, 2004 Edition, Section 'strcat() : DESCRIPTION' states that :
*
*                   "if copying takes place between objects that overlap, the behavior is undefined."
*
*               (4) String concatenation terminates when :
*
...
*                           Concatenation string buffer NOT modified.
*
*               len_max     Maximum number of characters to concatenate. 'len_max' number of characters
...
*               Pointer to NULL, otherwise (see Note #2).
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strncat() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strncat() : RETURN VALUE' states that :
*
...
*                   error(s).
*
*               (3) IEEE Std 1003.1, 2004 Edition, Section 'strncat() : DESCRIPTION' states that :
*
*                   "if copying takes place between objects that overlap, the behavior is undefined."
*
*               (4) String concatenation terminates when :
...
*
* Argument(s) : p1_str  Pointer to the first string. String buffer NOT modified.
*
*               p2_str  Pointer to the second string. String buffer NOT modified.
*
...
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strcmp() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strcmp() : RETURN VALUE' states that :
*
...
*               p2_str      Pointer to the second string. String buffer NOT modified.
*
*               len_max     Maximum number of characters to compare.
*
* Return(s)   : 0, if strings are identical.
*
*               Negative value, if 'p1_str' is less than 'p2_str'.
...
*               Positive value, if 'p1_str' is greater than 'p2_str'.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strncmp() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strncmp() : RETURN VALUE' states that :
*
...
*               Positive value, if 'p1_str' is greater than 'p2_str'.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strcasecmp() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strcasecmp() : RETURN VALUE' states that :
*
...
*               Positive value, if 'p1_str' is greater than 'p2_str'.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strncasecmp() : DESCRIPTION' states that :
*
...
*                   bytes [...] that differ in the strings being compared".
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strncasecmp() : RETURN VALUE' states that :
*
...
*
* Argument(s) : p_str       Pointer to the string. String buffer NOT modified.
*
*               srch_char   Search character.
*
* Return(s)   : Pointer to the first occurrence of search character in string, if any occur.
*
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strchr() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strchr() : RETURN VALUE' states that :
*
...
* Argument(s) : p_str       Pointer to the string. String buffer NOT modified.
*
*               len_max     Maximum number of characters to search. 'len_max' number of characters MAY
...
*
*               (4) Ideally, the 'len_max' argument would be the last argument in this function's
...
*               srch_char   Search character.
*
* Return(s)   : Pointer to the last occurrence of search character in string, if any.
*
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strrchr() : DESCRIPTION' states that :
*
*                   "The strrchr() function shall locate the last occurrence of 'c' ('srch_char') [...]
*                   in the string pointed to by 's' ('p_str'). [...] The terminating null byte is
*                   considered to be part of the string."
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strrchr() : RETURN VALUE' states that :
*
...
*
* Argument(s) : p_str           Pointer to the string. This string will be modified.
*
...
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) String search terminates when :
*
*                   (a) String pointer passed a NULL pointer. No string search performed. NULL pointer is
*                       returned.
*
...
*               char_replace    Replace character.
*
*               len_max         Maximum number of characters to search. 'len_max' number of characters
...
*               Pointer to NULL, otherwise.
*
* Note(s)     : (2) String search terminates when :
*
                    (a) String pointer passed a NULL pointer. No string search performed. NULL pointer is
*                       returned.
*
...
*
* Argument(s) : p_str       Pointer to a string. String buffer is NOT modified.
*
*               p_str_srch  Pointer to the search string. String buffer is NOT modified.
*
* Return(s)   : Pointer to the first occurrence of search string in the string, if any.
*
*               Pointer to the string, if search string has a zero length.
*
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strstr() : DESCRIPTION' states that :
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strstr() : RETURN VALUE' states that :
*
...
*               p_str_srch  Pointer to the search string. String buffer is NOT modified.
*
*               len_max     Maximum number of characters to search. 'len_max' number of characters does
...
*
*               nbr_dig     Number of digits to format.
*
...
*
*               nbr_base    Base of number to format. The number's base MUST be between 2 and 36,
*                           inclusively.
*
...
*
*               lead_char   Prepend leading character. Leading character option prepends leading
...
*
*               nul         Append terminating NULL-character. NULL-character terminate option DISABLED
...
*
*               p_str       Pointer to the character array to return formatted number string. Format
*                           buffer size is NOT validated; buffer overruns MUST be prevented by caller.
...
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) See Str_FmtNbr_Int32()'s notes.
*********************************************************************************************************
*/
...
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) The maximum accuracy for 32-bit floating-point numbers :
*
*
...
*
*               (3) String format terminates when :
*
...
*
*               (4) For any unsuccessful string format or error(s), an invalid string of question marks
...
*
* Return(s)   : Parsed integer, if integer parsed with NO overflow.
*
*               DEF_INT_32U_MAX_VAL, if integer parsed but overflowed.
*
*               0, otherwise.
*
* Note(s)     : (1) See Str_ParseNbr_Int32()'s notes.
*********************************************************************************************************
*/
...
*               Pointer to NULL, otherwise.
*
* Note(s)     : (1) The maximum number of digits to format for 32-bit integer numbers :
*
*
...
*               0, otherwise.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'strtoul() : DESCRIPTION' states that "these
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'strtoul() : ERRORS' states that "these
...
*
*               (3) IEEE Std 1003.1, 2004 Edition, Section 'strtoul() : ERRORS' states that "these
*                   functions may fail if [...] [EINVAL] - No conversion could be performed."
*
*               (4) Return integer value and next string pointer should be used to diagnose parse success
*                   or failure :
*
...
*
*
*               (5) String parse terminates when :
*
