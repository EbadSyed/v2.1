...
*
* Note(s)     : (1) The pseudo-random number generator is implemented as a Linear Congruential
*                   Generator (LCG).
*
...
*
*               (2) IEEE Std 1003.1, 2004 Edition, Section 'rand() : DESCRIPTION' states that "rand()
...
*
* Note(s)     : (1) BSD/ANSI-C implements rand() as a Linear Congruential Generator (LCG) :
*
