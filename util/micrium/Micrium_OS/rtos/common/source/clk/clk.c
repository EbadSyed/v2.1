...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Date/time ('p_date_time') should be set to local time with the correct time zone
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Timestamp ('ts_sec') MUST be set for UTC+00 & should not include the time
...
*                   (b) <  CLK_EPOCH_YR_END
*
*               (2) Date/time ('p_date_time') should be set to local time with correct time zone
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) NTP timestamp is converted from the internal Clock timestamp (should
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Timestamp ('ts_ntp_sec') MUST be set for UTC+00 and should NOT include the time
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Unix timestamp is converted from the internal Clock timestamp which should be set
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Timestamp ('ts_unix_sec') MUST be set for UTC+00 & should NOT include the time
...
*
* Note(s)     : (1) Most years that are evenly divisible by 4 are leap years; ...
