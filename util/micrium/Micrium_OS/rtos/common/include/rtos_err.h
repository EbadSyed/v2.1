...
*                                          RTOS_ERR_CODE_GET()
*
* Description : Obtains the error code from an error variable.
*
...
*
* Description : Refreshes extended error information with current context.
*
* Argument(s) : err_var     Error variable to refresh.
*
* Return(s)   : None.
*
* Note(s)     : None.
