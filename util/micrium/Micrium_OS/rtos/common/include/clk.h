...
*
*               (2) External timestamp SHOULD be an 'up' counter whose values increase at each
...
*
*
*               (2) Clock timestamp values MUST be returned via 'CLK_TS_SEC' data type.
*
...
*
*
*               (3) External timestamp values MUST be returned from the reference of the Clock
...
*					CLK_EPOCH_YR_START >= Date of external timestamp < CLK_EPOCH_YR_END.
*
...
*
*
*               (4) The Clock timestamp is calculated by one of the following equations :
*
...
*
*               (2) External timestamp values are converted from Clock timestamp's 'CLK_TS_SEC' data
*                   type.
*
*                   (a) If the External timestamp has more bits than the 'CLK_TS_SEC' data type,
...
*
*               (3) External timestamp values MUST be converted from the reference of the Clock epoch
*                   start date/time.
...
*
*               (4) The External timestamp is calculated by one of the following equations :
*
*                   (a) When External epoch start year is less than Clock epoch start year
*                       ('CLK_EPOCH_YR_START') :
*
