...
*
* Argument(s) : addr        Lowest CPU memory address of data value to decode (see Notes #2 & #3).
*
* Return(s)   : Decoded data value from CPU memory address (see Notes #1 & #3).
*
...
*
*               (3) MEM_VAL_GET_xxx() macro's decode data values without regard to CPU word-aligned addresses.
...
*
* Argument(s) : addr        Lowest CPU memory address to encode data value (see Notes #2 & #3).
*
*               val         Data value to encode (see Notes #1 & #3).
*
* Return(s)   : None.
*
...
*               (2) CPU memory addresses/pointers NOT checked for NULL.
*
*               (3) MEM_VAL_SET_xxx() macro's encode data values without regard to CPU word-aligned addresses.
