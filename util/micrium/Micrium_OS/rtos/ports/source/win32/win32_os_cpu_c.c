...
* Argument(s) : None.
*
* Return(s)   : DEF_TRUE,   current task     suspended successfully.
*               DEF_FALSE   current task NOT suspended.
*
* Note(s)     : (1) Current task MUST be suspended before OSIntEnter().
*
...
* Argument(s) : None.
*
* Return(s)   : DEF_TRUE,   current task     resumed successfully.
*               DEF_FALSE   current task NOT resumed.
*
* Note(s)     : (1) Current task MUST be resumed after OSIntExit().
*
*               (2) Suspending current task before OSIntEnter() and resuming it after OSIntExit() prevents
*                   task-level code to run concurrently with ISR-level code
*********************************************************************************************************
...
*                                              OSTickW32()
*
* Description : This function is the Win32 task that generates the tick interrupts for the Kernel.
*
* Argument(s) : p_arg   Pointer to argument of the task.
*
* Return(s)   : None.
*
...
*                                              OSTaskW32()
*
* Description : This function is a generic Win32 task wrapper for the created tasks.
*
* Argument(s) : p_arg   Pointer to argument of the task.
*
* Return(s)   : None.
...
*
* Argument(s) : p_tcb   Pointer to the task control block to retrieve the task information structure.
*
* Return(s)   : Task information.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
* Argument(s) : p_task  Pointer to the task information structure of the task to clear its control
*                       signals.
*
* Return(s)   : None.
*
...
*
* Argument(s) : ctrl    Control signal type.
*
* Return(s)   : TRUE,   control signal was     handled.
...
*
* Argument(s) : p_str   Pointer to format string output.
*
...
*
* Argument(s) : thread_id   Thread ID.
*
