...
*                                         OS_CPU_SysTickInit()
*
* Description : Initialize the system tick.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                          OSTimeTickHandler()
*
* Description : Handle Tick simulated interrupt.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                             OSTaskPosix()
*
* Description : This function is a generic POSIX task wrapper for created tasks.
*
* Argument(s) : p_arg   Pointer to argument of the task's TCB.
*
* Return(s)   : None.
*
