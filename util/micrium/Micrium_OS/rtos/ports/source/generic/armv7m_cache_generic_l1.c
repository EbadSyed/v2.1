...
*
* Argument(s) : addr_start  Start address of the region to invalidate.
*
*               len         Size of the region to invalidate in bytes.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Argument(s) : addr_start  Start address of the region to flush.
*
*               len         Size of the region to invalidate in bytes.
*
* Return(s)   : None.
...
* Argument(s) : None.
*
* Return(s)   : The size of a cache line, in bytes.
*
* Note(s)     : (1) Line Size = 2^(CCSIDR[2:0] + 2)
*********************************************************************************************************
*/
