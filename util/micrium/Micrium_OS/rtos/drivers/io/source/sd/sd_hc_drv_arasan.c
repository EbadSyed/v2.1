...
#include  <rtos/io/source/sd/sd_card_ctrlr_priv.h>
...
static  void                      SD_CtrlrDrvCardIntEnDis    (SD_CARD_DRV              *p_drvr,
                                                              CPU_BOOLEAN               enable);
...
static  SD_HOST_CAPABILITIES      SD_CtrlrCapabilitiesGet    (SD_CARD_DRV              *p_drv);

static  CPU_SIZE_T                SD_CtrlrReqAlignGet        (SD_CARD_DRV              *p_drv);
...
const  SD_CARD_CTRLR_DRV_API  SDHC_Drv_API_Arasan = {
    ...
    .CapabilitiesGet = SD_CtrlrCapabilitiesGet,
    .ReqAlignGet     = SD_CtrlrReqAlignGet
};
                                ...
                                RTOS_ERR     *p_err)
{
    ...
    p_regs->INTSTATEN    = (SDHC_INTSTATEN_RETUNE  |
                            SDHC_INTSTATEN_CARDREM |
                            SDHC_INTSTATEN_CARDINS);
...
static  void  SD_CtrlrISR_Handler (SD_CARD_DRV  *p_drv)
{
    ...
    if (DEF_BIT_IS_SET(intstatus, SDHC_INTSTATEN_CARDREM)) {
        ...
        /* MICRIUM-686 Notify core of card disconnection */
    }
