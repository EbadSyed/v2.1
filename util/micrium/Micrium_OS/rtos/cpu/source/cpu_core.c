...
* Return(s)   : None.
*
* Note(s)     : (1) CPU timestamp(s) MUST be updated periodically by some application (or BSP) time
...
* Return(s)   : None.
*
* Note(s)     : (1) CPU timestamp timer frequency is NOT required for internal CPU timestamp
...
* Return(s)   : None.
*
* Note(s)     : (1) The total amount of time interrupts are disabled by system &/or application code
...
*
* Note(s)     : (1) Supports the following data value sizes :
*
*                       8-bits,
*                       16-bits,
*                       32-bits,
...
*
*               (2) Interrupts disabled time measurement overhead performed multiple times to calculate
