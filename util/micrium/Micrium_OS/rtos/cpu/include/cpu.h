...
*
*               (2) CPU_SW_EXCEPTION()  MAY be developer-implemented to output &/or handle any error or
...
*
* Note(s)     : (1) Generic type values should be #define'd with large, non-trivial values to trap
...
* Argument(s) : None.
*
* Return(s)   : Timestamp timer count (see Notes #1c & #1d).
*
...
*
*               (2) This function is an INTERNAL CPU module function and your application MAY call it.
*********************************************************************************************************
*/
