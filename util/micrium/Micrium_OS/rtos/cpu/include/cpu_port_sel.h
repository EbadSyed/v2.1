...
#include  <rtos/common/include/rtos_path.h>
			...
			#include  <rtos/ports/source/armcc/armv7m_cpu_port.h>
		#elif (RTOS_TOOLCHAIN_NAME == RTOS_TOOLCHAIN_GNU)
			#include  <rtos/ports/source/gnu/armv7m_cpu_port.h>
		#elif (RTOS_TOOLCHAIN_NAME == RTOS_TOOLCHAIN_IAR)
			#include  <rtos/ports/source/iar/armv7m_cpu_port.h>
		#else
			...
			#include  <rtos/ports/source/gnu/posix_cpu_port.h>
		#else
			#warning  Unknown toolchain
		#endif
		...
		#include  <rtos/ports/source/win32/win32_cpu_port.h>
		#else
			#warning  Unknown toolchain
		#endif
