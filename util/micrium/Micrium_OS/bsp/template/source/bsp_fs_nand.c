...
*
* Description : Selects the NAND flash device using the Chip Enable signal (see Note #1).
*
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) This function may be ignored if the NAND memory controller allows to control directly
*                   the Chip Enable from one of its registers.
*
*               (2) If the NAND flash chip is the only device connected to the parallel bus, the slave
*                   ID can be ignored.
*********************************************************************************************************
*/
...
*
* Description : Unselects the NAND flash device using the Chip Enable signal (see Note #1).
*
* Argument(s) : part_slave_id   slave ID of the NAND chip in case parallel bus shared with other external
*                               devices (see Note #2).
*
...
*
* Description : Determines if the NAND flash device is ready using the Ready/Busy signal (see Note #1).
*
* Argument(s) : none.
*
...
*               DEF_NO,  otherwise.
*
* Note(s)     : (1) This function may be ignored if the NAND memory controller allows to monitor directly
*                   the Ready/Busy signal from one of its registers.
*
*********************************************************************************************************
*/
