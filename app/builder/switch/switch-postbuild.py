...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/es/Downloads/Softwares/SimplicityStudio_v4/developer/toolchains/gnu_arm/4.8_2013q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print " "
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/es/Downloads/Softwares/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/es/Downloads/Softwares/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
