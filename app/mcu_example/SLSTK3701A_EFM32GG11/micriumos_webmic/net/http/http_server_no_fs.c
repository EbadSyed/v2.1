/**************************************************************************//**
 * @file http_server_no_fs.c
 * @brief uC/HTTPs http server without filesystem
 * @version 5.3.5
 *******************************************************************************
 * # License
...
static CPU_INT08U index_html[] =
  ...
  "<p class='lead'>This webpage is served by a simple web server running on you development kit using the "
