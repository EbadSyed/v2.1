...
// This is a fake upgrade URI used for downloading images until we figure out
// how we want to obtain this URI. See also the coapDispatch setup block in
// the ota-bootload-server plugin.properties file.
#define EM_ZCL_OTA_BOOTLOAD_UPGRADE_URI "ota"
#endif
