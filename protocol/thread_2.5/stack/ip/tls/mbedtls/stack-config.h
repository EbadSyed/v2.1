 ...
 * \file config.h
 *
 * \brief Includes the cryptographic algorithms to support J-PAKE,
 *        and SSL/TLS capabilities.
 *
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO      umm_calloc /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO          umm_free /**< Default free macro to use, can be undefined */
